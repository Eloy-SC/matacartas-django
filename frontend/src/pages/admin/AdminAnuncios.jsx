								...
								<tr key={anuncio.id}>
									...
									<td>
										<div className="admin-actions">
											<button type="button" className="admin-icon-button" aria-label="Editar anuncio" onClick={() => navigate(`/admin/anuncios/${anuncio.id}`)} disabled={deletingId === anuncio.id}>
											...
											<button type="button" className="admin-delete-button" aria-label="Borrar anuncio" onClick={() => handleDelete(anuncio.id)} disabled={deletingId === anuncio.id}>
                                            ...
                                            <button type="button" className="admin-delete-button" aria-label="Publicar anuncio" onClick={() => handlePublicar(anuncio.id)} disabled={publicandoId === anuncio.id}>
												Publicar
											</button>
										</div>
									</td>

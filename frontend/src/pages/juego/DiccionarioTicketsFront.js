const DiccionarioTicketsFront = {
  ...
  ticket_rp_2_todos: { nombre: "Robo 2 (todos)", clase: "0ª clase", descripcion: "Robas 2 puntos de todos los jugadores." },
  ...
  ticket_cp_10: { nombre: "Canje 10", clase: "0ª clase", descripcion: "Canjea el ticket por 10 puntos." },
  ...
  ticket_rt_mayor_clase: { nombre: "Robo ticket (mayor clase)", clase: "0ª clase", descripcion: "Robas el ticket de mayor clase de otro jugador." },
};
